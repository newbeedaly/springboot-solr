package cn.newbeedaly.springbootsolr.controller;
...
public class SolrController {
  ...
  public String add() {
    ...
    try {
      ...
      doc.setField("id", "1"); // user_name , user_address
      doc.setField("user_name", "李乾坤");
      ...
      doc.setField("id", "2"); // user_name , user_address
  ...
  public String search(){
    ...
    try {
      ...
      //默认域
      params.set("df", "user_name");

      //只查询指定域
      params.set("fl", "id,user_name,user_address");
      ...
      return JSON.toJSONString(highlight);
    } catch (Exception e) {
      e.printStackTrace();
    }
    return null;
